...
#'
#'
#' @description To deliver Multiserver
#'
#'
#' @param Arrivals; Number of customers that have arrived
#' @param ServiceTimes; The amount of time taken to serve customer
#' @param NumServers; The number of servers (1)
#'
#' @return a 1x4 dataframe
#' @export
#'
#' @examples
#' Multiserver(Arrivals = "4", ServiceTimes = "300")
